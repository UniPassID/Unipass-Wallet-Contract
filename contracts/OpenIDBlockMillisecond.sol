...
contract OpenIDBlockMillisecond is Initializable, ModuleAdminAuth, UUPSUpgradeable {
    ...
    function _validateTimestamp(
        ...
        bytes32 timestamp = LibBytes.uint32ToASSCIIBytes32(uint32(block.timestamp / 1000));
